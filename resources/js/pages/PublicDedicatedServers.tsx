...
import { Check, Server, Zap, Shield, Globe, Cpu, HardDrive, Network, Lock } from 'lucide-react';
...
export default function PublicDedicatedServers({ products }: Props) {
    ...
    const handleConfirmAddToCart = async () => {
        ...
        try {
            ...
            if (response.data.success) {
                incrementCart();
                toast.success('Dedicated server plan added to cart!');
                setDialogOpen(false);
                setDomain('');
                ...
                toast.error(response.data.message || 'Failed to add dedicated server to cart');
            }
        } catch (error: any) {
            console.error('Add to cart failed:', error);
            const errorMessage = error.response?.data?.message || 'Failed to add dedicated server to cart';
    ...
    return (
        <PublicLayout title="Dedicated Servers - Enterprise-Grade Performance">
            {/* Hero Section */}
                ...
                <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
                    <div className="text-center">
                        ...
                        <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">
                            Enterprise-grade bare metal servers with maximum performance and complete control. Perfect for high-traffic applications and mission-critical workloads.
                        </p>
                    </div>
                    ...
                    <div className="mt-16 grid gap-8 md:grid-cols-4">
                        <div className="text-center">
                            ...
                            <h3 className="mt-4 text-lg font-semibold">Bare Metal Power</h3>
                        ...
                        <div className="text-center">
                            ...
                            <h3 className="mt-4 text-lg font-semibold">Maximum Security</h3>
                            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <div className="text-center">
                            ...
                            <h3 className="mt-4 text-lg font-semibold">Peak Performance</h3>
                            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="mb-12 text-center">
                        ...
                        <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">
                            Enterprise-grade hardware for your business
                        </p>
                    </div>
                    ...
                    <div className="grid gap-8 lg:grid-cols-2 md:grid-cols-1">
                        {products.map((product) => {
                            ...
                            return (
                                <Card key={product.id} className="flex flex-col border-orange-200">
                                    <CardHeader>
                                        ...
                                        {product.features.length > 0 ? (
                                            ...
                                            <div className="space-y-3">
                                                <div className="flex items-center gap-2 text-sm text-gray-500">
                                                    ...
                                                    <span>Server specifications to be added</span>
                                                </div>
                                            </div>
                                        )}
                                    </CardContent>
                    ...
                    {products.length === 0 && (
                        <div className="text-center py-12">
                            ...
                            <h3 className="mt-4 text-lg font-semibold text-gray-900 dark:text-white">
                                No dedicated server plans available
                            </h3>
                            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                                Please check back later or contact our sales team for custom configurations.
                            </p>
                        </div>
                    )}
                </div>
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid gap-8 md:grid-cols-3">
                        <div className="rounded-lg bg-white p-6 shadow-sm dark:bg-gray-800">
                            ...
                            <h3 className="mt-4 text-xl font-semibold">Maximum Performance</h3>
                            <p className="mt-2 text-gray-600 dark:text-gray-400">
                                All server resources are exclusively yours. No sharing means no performance degradation.
                            </p>
                        </div>
                        ...
                        <div className="rounded-lg bg-white p-6 shadow-sm dark:bg-gray-800">
                            ...
                            <p className="mt-2 text-gray-600 dark:text-gray-400">
                                Complete isolation from other users ensures maximum security for your data and applications.
                            </p>
                        </div>
                        
                        <div className="rounded-lg bg-white p-6 shadow-sm dark:bg-gray-800">
                            <HardDrive className="h-10 w-10 text-orange-600" />
                            <h3 className="mt-4 text-xl font-semibold">Full Customization</h3>
                            <p className="mt-2 text-gray-600 dark:text-gray-400">
                                Choose your OS, control panel, and configure the server exactly how you need it.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="mt-12 rounded-2xl bg-white p-8 shadow-lg dark:bg-gray-800">
                        ...
                        <div className="grid gap-6 md:grid-cols-2">
                            ...
                            <div className="flex items-start gap-3">
                                <Check className="h-5 w-5 flex-shrink-0 text-green-500" />
                                <div>
                                    <h4 className="font-semibold">Free Server Management</h4>
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>Add Dedicated Server to Cart</DialogTitle>
                        <DialogDescription>
                            {selectedProduct && selectedPlan && (
                                <>
                                    Enter the domain name for <strong>{selectedProduct.name}</strong> dedicated server plan 
                    ...
                    <div className="py-4">
                        ...
                        <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                            Enter the domain name you want to use for this dedicated server plan.
                        </p>
                    </div>
                    <DialogFooter>
                        <Button
